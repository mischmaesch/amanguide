...
var G__56811 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__56811;
continue;
}
break;
...
var G__56670 = (function (){var G__56674 = rdr;
G__56674.cljs$tools$reader$reader_types$IPushbackReader$unread$arity$2(null,ch);

return G__56674;
})();
var G__56671 = ch;
var G__56672 = opts;
var G__56673 = pending_forms;
return (cljs.tools.reader.read_tagged.cljs$core$IFn$_invoke$arity$4 ? cljs.tools.reader.read_tagged.cljs$core$IFn$_invoke$arity$4(G__56670,G__56671,G__56672,G__56673) : cljs.tools.reader.read_tagged.call(null,G__56670,G__56671,G__56672,G__56673));
}
} else {
...
if(("\\" === ch__$1)){
var ch_56812__$2 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
if((ch_56812__$2 == null)){
...
sb.append(ch_56812__$2);
} else {
}

var G__56813 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch__$1 = G__56813;
continue;
}
}
...
var vec__56678 = cljs.tools.reader.starting_line_col_info(rdr);
var start_line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56678,(0),null);
var start_column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56678,(1),null);
...
var G__56819 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(a,form);
a = G__56819;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__56681 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__56682 = true;
(cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__56682);

try{return cljs.tools.reader.read_delimited_internal(kind,delim,rdr,opts,pending_forms);
}finally {(cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__56681);
}});
/**
...
var vec__56686 = cljs.tools.reader.ending_line_col_info(rdr);
var end_line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56686,(0),null);
var end_column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56686,(1),null);
...
var vec__56689 = cljs.tools.reader.starting_line_col_info(rdr);
var start_line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56689,(0),null);
var start_column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56689,(1),null);
...
var vec__56692 = cljs.tools.reader.ending_line_col_info(rdr);
var end_line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56692,(0),null);
var end_column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56692,(1),null);
...
var vec__56695 = cljs.tools.reader.starting_line_col_info(rdr);
var start_line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56695,(0),null);
var start_column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56695,(1),null);
...
var vec__56698 = cljs.tools.reader.ending_line_col_info(rdr);
var end_line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56698,(0),null);
var end_column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56698,(1),null);
...
var sb = (function (){var G__56701 = (new goog.string.StringBuffer());
G__56701.append(initch);
...
var G__56820 = (function (){var G__56704 = sb;
G__56704.append(ch);

return G__56704;
})();
var G__56821 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
sb = G__56820;
ch = G__56821;
continue;
}
...
switch (G__56710) {
case "\\":
var G__56824 = (function (){var G__56711 = sb;
G__56711.append(cljs.tools.reader.escape_char(sb,reader));

return G__56711;
})();
var G__56825 = reader.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
sb = G__56824;
ch = G__56825;
continue;
...
break;
default:
var G__56826 = (function (){var G__56712 = sb;
G__56712.append(ch);

return G__56712;
})();
var G__56827 = reader.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
sb = G__56826;
ch = G__56827;
continue;
...
var vec__56715 = cljs.tools.reader.ending_line_col_info(rdr);
var end_line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56715,(0),null);
var end_column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56715,(1),null);
...
var vec__56719 = cljs.tools.reader.starting_line_col_info(rdr);
var line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56719,(0),null);
var column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56719,(1),null);
...
var G__56831 = matched;
var G__56832 = cljs.tools.reader.read_suppress(first_line,rdr,opts,pending_forms);
matched = G__56831;
finished = G__56832;
continue;
} else {
...
if(cljs.core.truth_(and__4115__auto__)){
var G__56769 = new cljs.core.Keyword(null,"read-cond","read-cond",1056899244).cljs$core$IFn$_invoke$arity$1(opts);
var fexpr__56768 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"preserve","preserve",1276846509),null,new cljs.core.Keyword(null,"allow","allow",-1857325745),null], null), null);
return (fexpr__56768.cljs$core$IFn$_invoke$arity$1 ? fexpr__56768.cljs$core$IFn$_invoke$arity$1(G__56769) : fexpr__56768.call(null,G__56769));
} else {
return and__4115__auto__;
}
})())){
...
var _STAR_suppress_read_STAR__orig_val__56770 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__56771 = (function (){var or__4126__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
...
(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__56771);
...
}finally {(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__56770);
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character(rdr);
}
...
var arg_env_orig_val__56772 = cljs.tools.reader.arg_env;
var arg_env_temp_val__56773 = cljs.core.sorted_map();
(cljs.tools.reader.arg_env = arg_env_temp_val__56773);

try{var form = (function (){var G__56774 = (function (){var G__56779 = rdr;
cljs.tools.reader.reader_types.unread(G__56779,"(");
...
var G__56776 = null;
var G__56777 = opts;
var G__56778 = pending_forms;
return (cljs.tools.reader.read_STAR_.cljs$core$IFn$_invoke$arity$5 ? cljs.tools.reader.read_STAR_.cljs$core$IFn$_invoke$arity$5(G__56774,G__56775,G__56776,G__56777,G__56778) : cljs.tools.reader.read_STAR_.call(null,G__56774,G__56775,G__56776,G__56777,G__56778));
})();
...
var G__56833 = (i + (1));
var G__56834 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(args,(function (){var or__4126__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
...
}finally {(cljs.tools.reader.arg_env = arg_env_orig_val__56772);
}});
/**
...
var ch = temp__5733__auto__;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("@",ch)){
return cljs.tools.reader.wrapping_reader(new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null))((function (){var G__56780 = rdr;
G__56780.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
...
var G__56835 = cljs.core.next(s__$1);
var G__56836 = ret;
s__$1 = G__56835;
r = G__56836;
continue;
...
var G__56837 = cljs.core.next(s);
var G__56838 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(key_vals,cljs.core.key(e)),cljs.core.val(e));
s = G__56837;
key_vals = G__56838;
continue;
} else {
...
return (new cljs.core.List(null,new cljs.core.Symbol("cljs.core","with-meta","cljs.core/with-meta",749126446,null),(new cljs.core.List(null,ret,(new cljs.core.List(null,(function (){var G__56784 = cljs.core.meta(form);
return (cljs.tools.reader.syntax_quote_STAR_.cljs$core$IFn$_invoke$arity$1 ? cljs.tools.reader.syntax_quote_STAR_.cljs$core$IFn$_invoke$arity$1(G__56784) : cljs.tools.reader.syntax_quote_STAR_.call(null,G__56784));
...
var gensym_env_orig_val__56786 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__56787 = cljs.core.PersistentArrayMap.EMPTY;
(cljs.tools.reader.gensym_env = gensym_env_temp_val__56787);
...
}finally {(cljs.tools.reader.gensym_env = gensym_env_orig_val__56786);
}});
...
var temp__5733__auto__ = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(token,":"))?cljs.core.ns_name(cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(":",cljs.core.first(token)))?(function (){var G__56788 = token;
var G__56788__$1 = (((G__56788 == null))?null:cljs.core.subs.cljs$core$IFn$_invoke$arity$2(G__56788,(1)));
var G__56788__$2 = (((G__56788__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol(G__56788__$1));
var G__56788__$3 = (((G__56788__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_(G__56788__$2));
var G__56788__$4 = (((G__56788__$3 == null))?null:cljs.core.symbol.cljs$core$IFn$_invoke$arity$1(G__56788__$3));
if((G__56788__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns(G__56788__$4);
}
})():(function (){var G__56789 = token;
var G__56789__$1 = (((G__56789 == null))?null:cljs.tools.reader.impl.commons.parse_symbol(G__56789));
if((G__56789__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_(G__56789__$1);
}
})()
));
if(cljs.core.truth_(temp__5733__auto__)){
...
var G__56795 = (cljs.tools.reader.read_STAR_.cljs$core$IFn$_invoke$arity$5 ? cljs.tools.reader.read_STAR_.cljs$core$IFn$_invoke$arity$5(rdr,true,null,opts,pending_forms) : cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__56795) : f.call(null,G__56795));
} else {
var temp__5733__auto____$1 = cljs.tools.reader._STAR_default_data_reader_fn_STAR_;
if(cljs.core.truth_(temp__5733__auto____$1)){
var f = temp__5733__auto____$1;
var G__56796 = tag;
var G__56797 = (cljs.tools.reader.read_STAR_.cljs$core$IFn$_invoke$arity$5 ? cljs.tools.reader.read_STAR_.cljs$core$IFn$_invoke$arity$5(rdr,true,null,opts,pending_forms) : cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__56796,G__56797) : f.call(null,G__56796,G__56797));
} else {
...
(cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__56803,reader){
...
var opts = map__56804__$1;
var eof = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__56804__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
