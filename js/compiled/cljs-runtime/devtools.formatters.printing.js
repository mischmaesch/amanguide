...
var len__4736__auto___56115 = arguments.length;
var i__4737__auto___56116 = (0);
while(true){
if((i__4737__auto___56116 < len__4736__auto___56115)){
args__4742__auto__.push((arguments[i__4737__auto___56116]));

var G__56117 = (i__4737__auto___56116 + (1));
i__4737__auto___56116 = G__56117;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq56048){
var G__56049 = cljs.core.first(seq56048);
var seq56048__$1 = cljs.core.next(seq56048);
var G__56050 = cljs.core.first(seq56048__$1);
var seq56048__$2 = cljs.core.next(seq56048__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__56049,G__56050,seq56048__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__56062_SHARP_){
return (!((cljs.core.meta(p1__56062_SHARP_) == null)));
})))){
...
var map__56067 = opts;
var map__56067__$1 = (((((!((map__56067 == null))))?(((((map__56067.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__56067.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__56067):map__56067);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56067__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e56073){var _e__53460__auto__ = e56073;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e56079){var _e__53460__auto__ = e56079;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__56081 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__56082 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__56082);

try{var map__56083 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56083__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__56081);
}});
...
var temp__5733__auto___56119 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___56119)){
var managed_print_level_56120 = temp__5733__auto___56119;
var _STAR_print_level_STAR__orig_val__56113_56122 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__56114_56123 = managed_print_level_56120;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__56114_56123);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__56085_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__56085_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__56113_56122);
}} else {
job_fn();
}
