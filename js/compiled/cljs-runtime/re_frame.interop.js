...
return [(function (){var pred__63868 = cljs.core.instance_QMARK_;
var expr__63869 = reactive_val;
if(cljs.core.truth_((pred__63868.cljs$core$IFn$_invoke$arity$2 ? pred__63868.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__63869) : pred__63868.call(null,reagent.ratom.RAtom,expr__63869)))){
return "ra";
} else {
if(cljs.core.truth_((pred__63868.cljs$core$IFn$_invoke$arity$2 ? pred__63868.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__63869) : pred__63868.call(null,reagent.ratom.RCursor,expr__63869)))){
return "rc";
} else {
if(cljs.core.truth_((pred__63868.cljs$core$IFn$_invoke$arity$2 ? pred__63868.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__63869) : pred__63868.call(null,reagent.ratom.Reaction,expr__63869)))){
return "rx";
} else {
if(cljs.core.truth_((pred__63868.cljs$core$IFn$_invoke$arity$2 ? pred__63868.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__63869) : pred__63868.call(null,reagent.ratom.Track,expr__63869)))){
return "tr";
} else {
return "other";
}
