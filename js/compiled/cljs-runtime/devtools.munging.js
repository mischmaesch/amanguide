...
var o55671 = temp__5733__auto__;
var temp__5733__auto____$1 = (o55671["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o55672 = temp__5733__auto____$1;
return (o55672["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__53450__auto__ = f;
return (o__53450__auto__["toString"]).call(o__53450__auto__);
} else {
return "";
}
}catch (e55673){var _ = e55673;
return "";
}});
...
try{var o__53450__auto___55812 = t;
(o__53450__auto___55812["cljs$lang$ctorPrWriter"]).call(o__53450__auto___55812,t,writer);
}catch (e55674){var __55813 = e55674;
}
...
var char_code = (function (){var o__53450__auto__ = (new String(char$));
return (o__53450__auto__["charCodeAt"]).call(o__53450__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__53450__auto__ = String;
return (o__53450__auto__["fromCharCode"]).call(o__53450__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__55675 = num_code;
switch (G__55675) {
case (1):
return (185);
...
var o__53450__auto__ = String;
return (o__53450__auto__["fromCharCode"]).call(o__53450__auto__,superscript_code);
});
/**
...
}catch (e55676){var _e__53460__auto__ = e55676;
return false;
}})())){
...
var vec__55677 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55677,(0),null);
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__55695){
var vec__55696 = p__55695;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55696,(0),null);
...
var G__55818 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__55819 = cljs.core.butlast(remaining_tokens);
name_tokens = G__55818;
remaining_tokens = G__55819;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq55693){
var G__55694 = cljs.core.first(seq55693);
var seq55693__$1 = cljs.core.next(seq55693);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__55694,seq55693__$1);
}));
...
var vec__55701 = cljs.core.split_with((function (p1__55700_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__55700_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55701,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55701,(1),null);
...
var vec__55707 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55707,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55707,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__55828 = cljs.core.rest(remaining_tokens);
var G__55829 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__55828;
name_tokens = G__55829;
continue;
} else {
...
var vec__55712 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55712,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55712,(1),null);
var vec__55715 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55715,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55715,(1),null);
var vec__55718 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55718,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55718,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55718,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55718,(3),null);
...
var vec__55733 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55733,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55733,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55733,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55733,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55733,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55733,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__55736 = temp__5733__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55736,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55736,(1),null);
var vec__55739 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55739,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55739,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__55742 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__55742) : devtools.munging.parse_fn_info_deep.call(null,G__55742));
})()));
}
} else {
return fn_info;
...
var G__55871 = (arity + (1));
var G__55872 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__55743){
var vec__55744 = p__55743;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55744,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55744,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__55747_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__55747_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__55748_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__55748_SHARP_);
}),sorted_infos);
...
var args__4742__auto__ = [];
var len__4736__auto___55909 = arguments.length;
var i__4737__auto___55910 = (0);
while(true){
if((i__4737__auto___55910 < len__4736__auto___55909)){
args__4742__auto__.push((arguments[i__4737__auto___55910]));

var G__55911 = (i__4737__auto___55910 + (1));
i__4737__auto___55910 = G__55911;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__55752){
var vec__55753 = p__55752;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55753,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq55749){
var G__55750 = cljs.core.first(seq55749);
var seq55749__$1 = cljs.core.next(seq55749);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__55750,seq55749__$1);
}));
...
var G__55756 = arg;
var G__55756__$1 = (((G__55756 instanceof cljs.core.Keyword))?G__55756.fqn:null);
switch (G__55756__$1) {
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55757__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55757__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55757__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55757__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__55758 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55758,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55758,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55758,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55758,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55758,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55758,(5),null);
...
var o__53450__auto__ = f;
return (o__53450__auto__["getBasis"]).call(o__53450__auto__);
});
/**
...
}catch (e55770){var _e__53460__auto__ = e55770;
...
var G__55953 = (obj[cljs.core.first(path)]);
var G__55954 = cljs.core.rest(path);
obj = G__55953;
path = G__55954;
continue;
} else {
...
var _STAR_ = (function (accum,p__55799){
var vec__55800 = p__55799;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55800,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55800,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__55803){
var vec__55804 = p__55803;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55804,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55804,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55804,(2),null);
...
var post_process = (function (p__55808){
var vec__55809 = p__55808;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55809,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55809,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__55807_SHARP_){
return (obj[cljs.core.first(p1__55807_SHARP_)]);
}),sorted_matches);
