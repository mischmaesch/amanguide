...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_56516 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_56516(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_56517 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_56517(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_56518 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_56518(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_56519 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_56519(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_56520 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_56520(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_56521 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_56521(reader);
}
});
...
var G__56525 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__56526 = s.append(c);
c = G__56525;
s = G__56526;
continue;
}
