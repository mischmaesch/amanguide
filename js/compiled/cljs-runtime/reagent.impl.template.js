...
var G__63683 = o;
goog.object.set(G__63683,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__63707__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__63707 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__63708__i = 0, G__63708__a = new Array(arguments.length -  0);
while (G__63708__i < G__63708__a.length) {G__63708__a[G__63708__i] = arguments[G__63708__i + 0]; ++G__63708__i;}
  args = new cljs.core.IndexedSeq(G__63708__a,0,null);
} 
return G__63707__delegate.call(this,args);};
G__63707.cljs$lang$maxFixedArity = 0;
G__63707.cljs$lang$applyTo = (function (arglist__63709){
var args = cljs.core.seq(arglist__63709);
return G__63707__delegate(args);
});
G__63707.cljs$core$IFn$_invoke$arity$variadic = G__63707__delegate;
return G__63707;
})()
;
} else {
...
var G__63684 = o;
goog.object.set(G__63684,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__63710__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__63711__i < G__63711__a.length) {G__63711__a[G__63711__i] = arguments[G__63711__i + 0]; ++G__63711__i;}
  args = new cljs.core.IndexedSeq(G__63711__a,0,null);
} 
return G__63710__delegate.call(this,args);};
G__63710.cljs$lang$maxFixedArity = 0;
G__63710.cljs$lang$applyTo = (function (arglist__63712){
var args = cljs.core.seq(arglist__63712);
return G__63710__delegate(args);
});
...
var G__63685 = props;
var G__63685__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__63685,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__63685);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__63685__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__63685__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__63686 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__63686,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__63686;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__63687){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63688__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__63690_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__63690_SHARP_);
}));
} else {
return null;
}
...
var vec__63692 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63692,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63692,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63692,(2),null);
...
var temp__5739__auto___63714 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___63714 == null)){
} else {
var key_63715 = temp__5739__auto___63714;
(jsprops.key = key_63715);
}
...
var temp__5739__auto___63716 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___63716 == null)){
} else {
var key_63717 = temp__5739__auto___63716;
(jsprops.key = key_63717);
}
...
var G__63696 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__63696) : reagent.impl.template.as_element.call(null,G__63696));
} else {
var temp__5739__auto___63718 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5739__auto___63718 == null)){
} else {
var key_63719 = temp__5739__auto___63718;
(jsprops.key = key_63719);
}
...
var G__63698 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__63698)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__63698)){
return x;
} else {
...
var len__4736__auto___63720 = arguments.length;
var i__4737__auto___63721 = (0);
while(true){
if((i__4737__auto___63721 < len__4736__auto___63720)){
args__4742__auto__.push((arguments[i__4737__auto___63721]));

var G__63722 = (i__4737__auto___63721 + (1));
i__4737__auto___63721 = G__63722;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq63699){
var G__63700 = cljs.core.first(seq63699);
var seq63699__$1 = cljs.core.next(seq63699);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__63700,seq63699__$1);
}));
...
var ctx = ({});
var vec__63703 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63703,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63703,(1),null);
...
var G__63706 = (cljs.core.count(argv) - first_child);
switch (G__63706) {
case (0):
